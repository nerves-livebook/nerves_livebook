defmodule NervesLivebook.MixProject do
  ...
  defp deps do
    [
      ...
      {:nerves_system_rpi0, "~> 1.26", runtime: false, targets: :rpi0},
      {:nerves_system_rpi0_2, "~> 1.26", runtime: false, targets: :rpi0_2},
      {:nerves_system_rpi2, "~> 1.26", runtime: false, targets: :rpi2},
      {:nerves_system_rpi3, "~> 1.26", runtime: false, targets: :rpi3},
      {:nerves_system_rpi3a, "~> 1.26", runtime: false, targets: :rpi3a},
      {:nerves_system_rpi4, "~> 1.26", runtime: false, targets: :rpi4},
      {:nerves_system_rpi5, "~> 0.1", runtime: false, targets: :rpi5},
      {:nerves_system_bbb, "~> 2.21", runtime: false, targets: :bbb},
      {:nerves_system_osd32mp1, "~> 0.17", runtime: false, targets: :osd32mp1},
      {:nerves_system_x86_64, "~> 1.26", runtime: false, targets: :x86_64},
